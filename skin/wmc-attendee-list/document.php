    ...
    <div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
      ...
      <div class="mission_conference_information">
        ...
        <div class="info">
          ...
          <?php
          $hiddenClass = $content->option->{'how_to_attend'} === '신청' ? '' : ' hidden';
          ?>
          ...
          <div class="info_line2">
            ...
            <div class="info_item <?php echo $hiddenClass; ?>"><span class="item_name">항공료(항공권기재)</span><span class="value"><?php echo $content->option->{'airfare_ticket_description'} ?>&nbsp;</span></div>
            <div class="info_item <?php echo $hiddenClass; ?>"><span class="item_name">항공료(KRW)</span><span class="value"><?php echo $content->option->{'airfare_krw'} ?>&nbsp;</span></div>
            <div class="info_item <?php echo $hiddenClass; ?>"><span class="item_name">인보이스</span><span class="value"><?php echo $content->option->{'invoice'} ?>&nbsp;</span></div>
            <div class="info_item <?php echo $hiddenClass; ?>"><span class="item_name">입금요청일</span><span class="value"><?php echo $content->option->{'deposit_request_date'} ?>&nbsp;</span></div>
            <div class="info_item <?php echo $hiddenClass; ?>"><span class="item_name">입금일</span><span class="value"><?php echo $content->option->{'deposit_date'} ?>&nbsp;</span></div>
          </div>
