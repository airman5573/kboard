<style>
.subtitle{ text-align: left; font-size: 1.25rem; font-weight: 700; color: #fff; margin: 20px 0 20px 0; width:100%!important; background: #555; padding: 10px; }
.personal_information { display: inline-block; margin-bottom:35px; width:100%; }
.personal_information .left { width: 19%; float: left; margin-right:1%; }
.personal_information .left .portrait { width: 180px; height: 180px; background-image: url(<?php echo $content->attach->{'portrait'}[0]; ?>) !important; background-position: center top !important; background-repeat: no-repeat !important; background-size: cover !important; background-blend-mode: multiply;}
...
.personal_information .right .info_1line .info_item span.title { font-size: 2rem; font-weight: 700; }
.personal_information .right .info_1line .info_item span { font-size: 1.2rem; font-weight: 300; }
.personal_information .right .info_2line .info_item { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.personal_information .right .info_2line .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.personal_information .right .info_2line .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }
.personal_information .right .info_2line .info_item.last_item1 { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.personal_information .right .info_2line .info_item.last_item2 { width:74.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }

.family_information { display: inline-block; margin-bottom:35px; width:100%; }
.family_information .left { width: 49%; float: left; margin-right:1%; }
.family_information .left .family_photo { width: 500px; height: 300px; background-image: url(<?php echo $content->attach->{'family_photo'}[0]; ?>) !important; background-position: center top !important; background-repeat: no-repeat !important; background-size: cover !important; background-blend-mode: multiply;}
.family_information .left img { max-width: 500px; width:100%; border: 2px solid #888; }
.family_information .right { width: 50%; float: right; }
.family_information .right .info_line .info_item { width:100%; display: inline-block;  border-bottom: 0px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.family_information .right .info_line .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.family_information .right .info_line .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.missionary_history_information { display: inline-block; margin-bottom:35px; width:100%; }
.missionary_history_information .info { width: 100%; float: left; }
.missionary_history_information .info .info_line .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.missionary_history_information .info .info_line .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.missionary_history_information .info .info_line .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.mission_country_information { display: inline-block; margin-bottom:35px; width:100%; } 
.mission_country_information .info { width: 100%; float: left; }
.mission_country_information .info .info_line1 .info_item { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_country_information .info .info_line2 .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_country_information .info .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.mission_country_information .info .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.ministry_status_information { display: inline-block; margin-bottom:35px; width:100%; } 
.ministry_status_information .info { width: 100%; float: left; }
.ministry_status_information .info .info_line1 .info_item { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.ministry_status_information .info .info_line2 .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.ministry_status_information .info .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.ministry_status_information .info .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.prayer_title_information { display: inline-block; margin-bottom:35px; width:100%; }
.prayer_title_information .info { width: 100%; float: left; }
.prayer_title_information .info .info_line .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.prayer_title_information .info .info_line .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.prayer_title_information .info .info_line .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.request_for_support_area { display: inline-block; margin-bottom:35px; width:100%; }
.request_for_support_area .info { width: 100%; float: left; }
.request_for_support_area .info .info_line .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.request_for_support_area .info .info_line .info_item span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.request_for_support_area .info .info_line .info_item span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }

.mission_conference_information { display: inline-block; margin-bottom:35px; width:100%; } 
.mission_conference_information .info { width: 100%; float: left; }
.mission_conference_information .info .info_line1 .info_item { width:100%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_conference_information .info .info_line2 .info_item { width:19.7%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_conference_information .info .info_line3 .info_item { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_conference_information .info .info_line4 .info_item1 { width:24.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_conference_information .info .info_line4 .info_item2 { width:74.5%; display: inline-block;  border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px; }
.mission_conference_information .info span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#999; margin-bottom: 5px; }
.mission_conference_information .info span.value { display: inline-block; font-size: 1.25rem; font-weight: 400; width:100%; color:#222; margin-bottom: 10px; }
	...
	<div id="kboard-wmc-attendee-list-document">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		    ...
		    <div class="missionary_history_information">
		        ...
		        <div class="info">
		            <div class="info_line">
		                <div class="info_item"><span class="item_name">선교사(사역자) 이력</span><span class="value"><?php echo wpautop($content->option->{'missionary_history'.$index})?>&nbsp;</span></div>
		            </div>      
		        </div>
		    </div>
		    ...
		    <div class="prayer_title_information">
		        ...
		        <div class="info">
		            <div class="info_line">
		                <div class="info_item"><span class="item_name">기도제목</span><span class="value"><?php echo $content->content?>&nbsp;</span></div>
		            </div>      
		        </div>
		    </div>
		    <div class="request_for_support_area">
		        ...
		        <div class="info">
		            <div class="info_line">
		                <div class="info_item"><span class="item_name">임마누엘서울교회에 지원 요청사항</span><span class="value"><?php echo wpautop($content->option->{'request_for_support'.$index})?>&nbsp;</span></div>
		            </div>      
		        </div>
		    </div>
		...
		<div class="kboard-control">
			...
			<?php if($content->isEditor() || $board->permission_write=='all'):?>
				<a href="<?php echo $url->getContentEditor($content->uid)?>" class="kboard-wmc-attendee-list-button-small"><?php echo __('수정', 'kboard-wmc-attendee-list')?></a>
				<a href="<?php echo $url->getContentRemove($content->uid)?>" class="kboard-wmc-attendee-list-button-small" onclick="return confirm('<?php echo __('Are you sure you want to delete?', 'kboard')?>');"><?php echo __('삭제', 'kboard-wmc-attendee-list')?></a>
			<?php endif?>
			</div>
		</div>
